...
* [`sfs`](https://web.archive.org/web/20170315134201/https://www.d-rift.nl/combuster/vdisk/sfs.html) (currently read-only)
...
* `ext2`: enables the `ext2` filesystem support

* `sfs`: enable the `sfs` filesystem support

* `std`: enables the features depending on the standard library

By default, no feature is set.
