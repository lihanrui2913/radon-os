...
pub enum Ext2Error {
    ...
    /// Tried to write a [`Gid`](crate::fs::types::Gid) containing a value bigger than [`u16::MAX`] in an inode.
    ...
    /// Tried to write a [`Uid`](crate::fs::types::Uid) containing a value bigger than [`u16::MAX`] in an inode.
